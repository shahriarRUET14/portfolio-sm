...
export const seoData: SEODataType = {
  title: 'Shahriar Mahmud — Senior Software Engineer',
  description:
    'Senior Software Engineer specializing in FinTech microservices, Spring Boot, and scalable enterprise platforms.',
